...
function GiftCouponCard() {
  ...
  const {getCoupon,coupon,isCouponApplied,removeCoupon ,applyCoupon}=useCartStore()
  ...
  return (
    <motion.div
      className='space-y-4 rounded-lg border border-gray-700 bg-gray-800/0 p-4 shadow-sm sm:p-6'
